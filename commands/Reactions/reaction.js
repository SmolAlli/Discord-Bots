...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand((subcommand) =>
            subcommand
                ...
                .addStringOption((option) =>
                    option.setName('emoji').setDescription('The emoji to have the role reaction be').setRequired(true)
                )
                .addRoleOption((option) =>
                    option.setName('role').setDescription('The role to use for the role reaction').setRequired(true)
                )
        )
        .addSubcommand((subcommand) =>
            subcommand
    ...
    async execute(interaction) {
        // Checks which subcommand was selected
        let replyMessage = '';
