            ...
            .addFields(
                {
                    ...
                    value: 'It is a feature of this bot (BD Gaming) that creates a temporary Voice Chat whenever you join the <#943642759175213076>. This voice chat will only exist while at least 1 person is in the channel.',
                },
                // { name: '\u200B', value: '\u200B' },
                {
                    name: 'Commands:',
                    value: '/vc name <name> - Changes the name of the Voice Chat to whatever is given.\n/vc limit <limit> - Changes the amount of people who can join.\n/vc edit <name> <limit> - changes both of those simultaneously.\nKeep in mind that these commands can only be used by staff or the person who created the temporary VC.',
                }
